...
public class Obstacle extends Figure {
	...
	* @param p1 l'extrémité d'une diagonale
	...
	*/
	...
	public Point barycentre() {
		Vecteur v = new Vecteur(Vecteur.CARTESIEN,width, height); v.homothetie(0.5);
	...
	public Point sommet(int num) {
		switch(num){
			case 0 : { return new Point(Point.CARTESIEN,(int)p1.abscisse(),(int)p1.ordonnee());}
			case 1 : { return new Point(Point.CARTESIEN,(int)p1.abscisse()+width,(int)p1.ordonnee()); }
			case 2 : { return new Point(Point.CARTESIEN,(int)p1.abscisse()+width,(int)p1.ordonnee()+height);}
			default: { return new Point(Point.CARTESIEN,(int)p1.abscisse(),(int)p1.ordonnee()+height);}
		}
	}
	/* (non-Javadoc)
